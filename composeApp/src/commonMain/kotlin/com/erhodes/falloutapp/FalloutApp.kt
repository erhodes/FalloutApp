        ...
        NavHost(
            ...
            composable(route = FalloutScreen.CharacterScreen.name) {
                ...
                CharacterScreen(
                    ...
                    onCraftRecipe = { characterViewModel.onCraftRecipe(it) },
                    onAddCraftedToLoadout = { characterViewModel.addCraftedItemToLoadout(it) },
                    onAddCraftedToInventory = { characterViewModel.addCraftedItemToInventory(it) },
